...
const char* ssid = "CHT2151";        // Wi-Fi 名稱
const char* password = "TECH921212";  // Wi-Fi 密碼

// 固定 IP 設定
IPAddress local_IP(192, 168, 1, 116);  // 你希望 ESP32 保持的固定 IP
IPAddress gateway(192, 168, 1, 1);     // 路由器的 IP 位址
